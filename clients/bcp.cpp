...
void bc_message(void *inst, char *targ, char *nick, char *user, char *host,
                char *mess) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_action(void *inst, char *targ, char *nick, char *user, char *host,
               char *mess) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_notice(void *inst, char *targ, char *nick, char *user, char *host,
               char *mess) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_ctcp(void *inst, char *targ, char *nick, char *user, char *host,
             char *mess) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_part(void *inst, char *targ, char *nick, char *user, char *host,
             char *mess) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_kick(void *inst, char *chan, char *kick, char *mess, char *nick,
             char *user, char *host) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_mode(void *inst, char *nick, char *user, char *host, char *mode,
             char *targ) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_channel_add(void *inst, char *chan, char *nick, char *user, char *host,
                    char *serv, char *mode, char *real) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_nickchangefail(void *inst, char *oldn, char *badn, char *mess,
                       char *numb) {
  cClient *c;
  c = (cClient *)inst;
...
void bc_unknown_message(void *inst, char *targ, char *nick, char *user,
                        char *host, char *mess) {
  cClient *c;
  c = (cClient *)inst;
